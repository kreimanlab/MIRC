...
# ATTENTION: the order of these contrasts should be THE SAME as that in the loaded variable conds_names
# n_significant_by_contrasts = {'mirc_vs_submirc':156, 'full_vs_submirc':91, 'submirc_vs_submirc_post':39}
n_significant_by_contrasts = {'mirc_vs_submirc':156, 'full_vs_submirc':91, 'submirc_vs_submirc_post':84}
# These data are used to set the axis limits
#lim_x_axis_by_contrast = {'mirc_vs_submirc':170, 'full_vs_submirc':170, 'submirc_vs_submirc_post':60}
lim_x_axis_by_contrast = {'mirc_vs_submirc':170, 'full_vs_submirc':170, 'submirc_vs_submirc_post':120}
n_significant_total = np.sum([val for val in n_significant_by_contrasts.values()])
...
if False:
    ...
    res_file_name = 'Test_results_responsive_AND_selective__submirc_vs_submirc_post_shuffle_NON_parametric_tests_remove_outliers_single_electrode__ 50-550ms.pickle'
elif False:
    # set this branch to True to plot results of the shuffling analysis for the object vs subMIRC condition
    res_file_name = 'results_responsive_AND_selective__full_vs_submirc_shuffle_NON_parametric_tests_remove_outliers_single_electrode__ 50-550ms.pickle'
...
for curr_contrast_ind, curr_contrast_name in enumerate(contrasts_names):
    ...
    n, bins, rectangles = axes.hist(curr_shufflings, bins=20, density=True, label='bootstrapping distribution', color='dimgray')
