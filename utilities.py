'''
This file contains routines that are used in my analysis of the MIRC paper
'''
import os
import numpy as np
...
# ----------------------------- IMPORTANT -----------------------------
# SET THIS BASE DIRECTORY TO WHEREVER YOU SAVED THE DOWNLOADED FILES
base_dir = 'C:\\Data_Tonino\\OneDrive - unime.it\\2023-MIRCs\\data_and_code_to_share'
# base_dir = 'D:\\Data_Tonino\\OneDrive - unime.it\\2023-MIRCs\\data_and_code_to_share'
...
def get_bad_channels(subj_num):
    ...
    if subj_num == 1:
        ...
        # Data for subject 4 are very noisy with a lot of 10-20Hz noise.
        # I leave only one channel so that my data processing routines do not issue an error message
        bad_channels = list(range(2, 213))
    elif subj_num == 5:
        bad_channels = [87, 133, 134, 135]
    # This is an electrode in area G_temp_sup-Lateral that, when considered, made the whole classifier NOT coverge!
    elif subj_num == 6:
        bad_channels = [114]
    elif subj_num == 10:
