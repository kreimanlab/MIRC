'''
This Python file generates results reported in Fig. 1 in the main manuscript and Fig. S3 in the supplementary materials
for paper:
...
# Threshold for discriminating between mirc and submirc (following Ullman et al.'s original paper)
